...
namespace Stellar\Facades\Faker\Enum;

enum Locale: string
{
    case CROATIAN_CROATIA = 'hr_HR';
    case CHINESE_SIMPLIFIED_CHINA = 'zh_CN';
    case CHINESE_TRADITIONAL_TAIWAN = 'zh_TW';
    case DUTCH_BELGIUM = 'nl_BE';
    case DUTCH_NETHERLANDS = 'nl_NL';
    case ENGLISH_HONG_KONG = 'en_HK';
    ...
    case MONTENEGRIN_MONTENEGRO = 'me_ME';
